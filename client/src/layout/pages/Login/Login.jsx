...
class Login extends Component {
    ...
    callBackEnd = async () => {
        let axiosResponse = await  axios.get('/scrab');
        this.setState({backendResponse: axiosResponse.data})
    }
    render() {
        const { erroMessage, backendResponse } = this.state;
        return (
            <div style={styles.container}>
                <Card style={styles.card}>
                    ...
                    <CardContent>
                        ...
                        <div>
                            <button className="btn btn-info" style={{ height: 45, width: 150 }}
